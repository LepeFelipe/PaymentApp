...
import cl.flepe.payment.ui.installments.InstallmentsFragmentArgs
import cl.flepe.payment.ui.installments.InstallmentsFragmentDirections
...
class PaymentNavigator @Inject constructor() {
    ...
    internal fun goToResume(
        ...
        val direction =
            InstallmentsFragmentDirections.actionInstallmentsToResume(
                amount,
                creditCard,
                cardIssuer,
                installment
